...
public class MessageResourceIntTest {
    ...
    private static final ZonedDateTime DEFAULT_SENT = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_SENT = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);

    private static final ZonedDateTime DEFAULT_RECIVED = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_RECIVED = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getRecived()).isEqualTo(DEFAULT_RECIVED);
    }
    ...
    public void getAllMessages() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sent").value(hasItem(sameInstant(DEFAULT_SENT))))
            .andExpect(jsonPath("$.[*].recived").value(hasItem(sameInstant(DEFAULT_RECIVED))));
    }
    ...
    public void getMessage() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages/{id}", message.getId()))
            ...
            .andExpect(jsonPath("$.sent").value(sameInstant(DEFAULT_SENT)))
            .andExpect(jsonPath("$.recived").value(sameInstant(DEFAULT_RECIVED)));
    }
    ...
    public void updateMessage() throws Exception {
        ...
        assertThat(testMessage.getRecived()).isEqualTo(UPDATED_RECIVED);
    }
